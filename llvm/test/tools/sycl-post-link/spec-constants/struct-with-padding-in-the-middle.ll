...
; RUN: %if asserts %{ sycl-post-link -properties -json=0 -debug-only=SpecConst --spec-const=native -S %s 2>&1 | FileCheck %s --check-prefix=CHECK-LOG %}
...
%struct.user_defined_type = type <{ float, i8, [3 x i8], i32, i8, [3 x i8] }>
%"class.sycl::_V1::id" = type { %"class.sycl::_V1::detail::array" }
%"class.sycl::_V1::detail::array" = type { [1 x i64] }

$_ZTSZZ4mainENKUlRN4sycl3_V17handlerEE_clES2_EUlNS0_14kernel_handlerEE_ = comdat any

@__usid_str = private unnamed_addr constant [34 x i8] c"uidc5885cee0b80ad9d____ZL7spec_id\00", align 1
@_ZL7spec_id = internal addrspace(1) constant { { float, i8, i32, i8 } } { { float, i8, i32, i8 } { float 0x40091EB860000000, i8 97, i32 42, i8 8 } }, align 4
...
entry:
  ...
  call spir_func void @_Z40__sycl_getComposite2020SpecConstantValueI17user_defined_typeET_PKcPKvS5_(%struct.user_defined_type addrspace(4)* sret(%struct.user_defined_type) align 4 %ref.tmp.ascast.i, i8 addrspace(4)* noundef addrspacecast (i8* getelementptr inbounds ([34 x i8], [34 x i8]* @__usid_str, i64 0, i64 0) to i8 addrspace(4)*), i8 addrspace(4)* noundef addrspacecast (i8 addrspace(1)* bitcast ({ { float, i8, i32, i8 } } addrspace(1)* @_ZL7spec_id to i8 addrspace(1)*) to i8 addrspace(4)*), i8 addrspace(4)* noundef null) #5
  ...
  call void @llvm.memcpy.p1i8.p0i8.i64(i8 addrspace(1)* align 4 %3, i8* align 4 %4, i64 13, i1 false), !tbaa.struct !53
...
!46 = !{!"host", i32 0}
!47 = !{!"clang version 17.0.0 (https://github.com/intel/llvm.git 2b62c1da227ed799217a86681217f4b3193e19c7)"}
!48 = !{i32 461}
...
!53 = !{i64 0, i64 4, !54, i64 4, i64 1, !58, i64 8, i64 4, !59, i64 12, i64 1, !58}
!54 = !{!55, !55, i64 0}
!55 = !{!"float", !56, i64 0}
