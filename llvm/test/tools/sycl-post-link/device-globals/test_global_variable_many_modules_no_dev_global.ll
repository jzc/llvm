...
; This is not a device_global variable: no "sycl-device-global-size" property
attributes #0 = { "sycl-unique-id"="dg_int2" "device_image_scope" "host_access"="1" "implement_in_csr"="true" "init_mode"="0" }
